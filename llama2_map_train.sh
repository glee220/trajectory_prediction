#!/bin/bash 
#SBATCH --job-name=lyj_llama2_map_train  # 定义作业名称
#SBATCH --output=llama2_map_train_%j.log    # 标准输出文件
...
deepspeed  /home/liuyanjiao/trajectory_predict/trajectory_predict_train.py \
 ...
 --model_comment llama2_map_train \
 --use_map \
 --learning_rate 1e-5
#   2>&1 | tee lyj_llama2_map_train.log

# 启动
# sbatch llama2_map_train.sh
# sbatch --mem=0 llama2_map_train.sh
