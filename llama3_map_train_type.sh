#!/bin/bash 
#SBATCH --job-name=lyj_llama3  # 定义作业名称
#SBATCH --output=llama3_map_train_%j.log    # 标准输出文件
...
deepspeed  /home/liuyanjiao/trajectory_predict/trajectory_predict_train_type.py \
 --num_workers 4  \
 --deepspeed ./config/ds_config_onslurm.json \
 --llm_model LLAMA3 \
 --llm_model_path ./models/Meta-Llama-3-8B-Instruct/ \
 --model_comment llama3_map_train_type \
 --use_map 

# 启动
# sbatch llama3_map_train_type.sh
# sbatch --mem=0 llama3_map_train_type.sh
