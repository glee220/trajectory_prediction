...
class Dataset_Nuscene(Dataset):
    ...
    def __read_data__(self):  
        ...
        return_file_path = f'./process_data_{self.flag}.pkl'
    ...
    def __social_load__(self):
        # self.with_map_path = f'./precess_data/return_data_list_{self.flag}.pkl'        
        self.with_map_path =  f'./process_data_{self.flag}.pkl'   
        ...
        if not os.path.exists(self.with_map_path):
            ...
            try:
                for scene_segment in tqdm(self.scene_segment_datalist):            
                    ...
                    map_mask = (self.nuscene_layers_map[self.scene_map[scene_name]].get_map_mask(patch_box, patch_angle, self.layer_names, canvas_size) * 255.0).astype(np.uint8)
    ...
    def get_scene_map(self, map_name_path):
        ...
        '''
        base_dir = os.path.dirname(os.path.abspath(__file__))  # …/preprocess_data
