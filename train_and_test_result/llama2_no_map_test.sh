#!/bin/bash 
#SBATCH --job-name=lyj_llama2_no_map_test  # 定义作业名称
#SBATCH --output=llama2_no_map_test_%j.log    # 标准输出文件
...
deepspeed  /home/liuyanjiao/trajectory_predict/test_metrics.py \
            --checkpoint_path checkpoints/Exp_llama2_nomap_train_20250717_095002/best_model.pth \
            --llm_model LLAMA \
            --llm_model_path ./models/Llama-2-7b-hf/ 

# 启动
# sbatch llama2_no_map_test.sh
# sbatch --mem=0 llama2_no_map_test.sh
