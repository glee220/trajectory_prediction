#!/bin/bash 
#SBATCH --job-name=lyj_llama2_nomap_train  # 定义作业名称
#SBATCH --output=llama2_nomap_train_%j.log    # 标准输出文件
...
deepspeed  /home/liuyanjiao/trajectory_predict/trajectory_predict_train.py \
 ...
 --model_comment llama2_nomap_train \
 --learning_rate 1e-5

# 启动
# sbatch llama2_nomap_train.sh
# sbatch --mem=0 llama2_nomap_train.sh
