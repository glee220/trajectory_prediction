...
#SBATCH --output=llama3_map_test_visi_all_%j.log    # 标准输出文件
...
deepspeed  /home/liuyanjiao/trajectory_predict/test_metrics_vis_all.py \
            --checkpoint_path checkpoints/Exp_llama3_nomap_train_20250713_214042/best_model.pth \
            --llm_model LLAMA3 \
            --llm_model_path ./models/Meta-Llama-3-8B-Instruct/        
            
# 启动
# sbatch llama3_map_test_visi_all_withoutmap.sh
# sbatch --mem=0 llama3_map_test_visi_all_withoutmap.sh
