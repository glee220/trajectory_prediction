...
class Trainer:
    ...
    def _build_dataloaders(self):
        ...
        train_data_set, train_dl = data_provider(args, "train", 'type')
        val_data_set, val_dl   = data_provider(args, "val",   'type')

        return train_dl, val_dl

    def _training_step(self, batch):
        (batch_agent_vec, batch_nbr_rlpos_mask, batch_nbr_rlpos, batch_nbr_vec_mask, batch_nbr_vec, batch_agent_pos, batch_vehicle_map, batch_motion_type) = batch
